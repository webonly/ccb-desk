...
console.log(b);
		...
		case audioCmdEnum.AudioCtrl:
			switch (b.audioCtrl.action) {
				...
				case "item":
				    $(".voice-cont").text(b.audioCtrl.cmd);
					if (b.audioCtrl.value==1) openNav(1,0);
					if (b.audioCtrl.value==2) openNav(2,0);
					if (b.audioCtrl.value==3) openNav(3,0);
					if (b.audioCtrl.value==4) openNav(4,0);
					if (b.audioCtrl.value==5) openNav(5,0);
					break;
				//case "gohome":
				//	goBack()
			}
